...
import {
  ...
  export function useSearchPage() {
    ...
    const sortCriteria = useSelector((state: RootState) => state.searchPage.sortCriteria);
    const resultsPerPage = useSelector((state: RootState) => state.searchPage.resultsPerPage);
    const repositories = useSelector((state: RootState) => state.searchPage.repositories);
    const pagination = useSelector((state: RootState) => state.searchPage.pagination);
